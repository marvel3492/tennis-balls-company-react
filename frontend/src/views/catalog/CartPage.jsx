...
import { isCart, isUser } from "shared/src/Data";
import { getCartLength } from "shared/src/Cart";
...
export default function CartPage() {
    ...
    const handleSubmit = (/** @type SubmitFormEvent */ e, /** @type number */ product_id) => {
    ...
    function checkout(/** @type React.MouseEvent<HTMLButtonElement> */ e) {
        e.preventDefault();
    ...
    useEffect(showCart, [setResponse]);
    if (response === null) {
        return <p>Loading...</p>;
        ...
        if (getCartLength(response.cart) > 0) {
            return (
                <>
                    <p>Products selected in your cart:</p>
                    <table border={1}>
                        <thead>
                            <tr>
                                <th>Product Name</th>
