...
import { fetchWithCatch, useResponseState, hasError, fetchDataWithCatch } from "../Utils";
...
export default function Header() {
    ...
    const logout = (/** @type React.MouseEvent<HTMLAnchorElement> */ e) => {
        e.preventDefault(); // prevent page reload
    ...
    useEffect(() => fetchDataWithCatch("http://localhost:5000/customer/credentials", (data) => setResponse(data), setResponse, {credentials: "include"}), [setResponse]);
    if (response === null) {
        return <p>Loading...</p>;
